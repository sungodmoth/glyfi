...
\def\GlyphChallengeAnnouncement{
    \foreach \w/\x/\y/\z in {
        \NextWeekColor/\NextWeekGlyph/\StartDate/\EndDate
    }{
...
\def\GlyphChallengeFirst{
    \ChallengeWinners{GlyphWinnerFirst}{\ThisWeekColor}{\GlyphWinnerFirst}{0}{12}{\GlyphWinnerFirstID}{\GlyphWinnerFirstSubID}{glyph}{\WeekNum}
}
\def\GlyphChallengeSecond{
    \ChallengeWinners{GlyphWinnerSecond}{\NextWeekColor}{\GlyphWinnerSecond}{0}{12}{\GlyphWinnerSecondID}{\GlyphWinnerSecondSubID}{glyph}{\WeekNum}
}
\def\GlyphChallengeThird{
    \ChallengeWinners{GlyphWinnerThird}{\OtherColor}{\GlyphWinnerThird}{0}{12}{\GlyphWinnerThirdID}{\GlyphWinnerThirdSubID}{glyph}{\WeekNum}
}
...
\newcommand{\GlyphChallengeShowcase}[2]{
    \Pollcase
        ...
        {\origdate\daterange\StartDate\EndDate} % #9 DATE (ORANGE SUBTITLE)
...
\newcommand{\GlyphPoll}[1] {\Pollcase
    ...
    {\printdayoff\origdate\StartDate} % #9 DATE (ORANGE SUBTITLE)
    {1} % ##1 ASPECT RATIO (WIDTH OVER HEIGHT)
...
\def\AmbigramChallengeAnnouncement{
    \foreach \w/\x/\y/\z in {
        Purple/\NextWeekAmbigram/\StartDate/\EndDate
    }{
...
\def\AmbigramChallengeFirst{
    \ChallengeWinners{AmbiWinnerFirst}{Pink}{\AmbiWinnerFirst}{1}{15}{\AmbiWinnerFirstID}{\AmbiWinnerFirstSubID}{ambi}{\WeekNum}
}
\def\AmbigramChallengeSecond{
    \ChallengeWinners{AmbiWinnerSecond}{Cyan}{\AmbiWinnerSecond}{1}{15}{\AmbiWinnerSecondID}{\AmbiWinnerSecondSubID}{ambi}{\WeekNum}
}
\def\AmbigramChallengeThird{
    \ChallengeWinners{AmbiWinnerThird}{Red}{\AmbiWinnerThird}{1}{15}{\AmbiWinnerThirdID}{\AmbiWinnerThirdSubID}{ambi}{\WeekNum}
}
...
% FOR SOME BIZARRE REASON, SHADOWS OF \INCLUDEGRAPHICS ELEMENTS ARE SLIGHTLY SCALED UP
	...
	% BACKGROUND
        ...
        % ARTWORK
        \node [WithShadow] at (0,0) {\includegraphics[width=#5cm,height=8cm,keepaspectratio] {images/#8/#9/#7}};
...
\newcommand{\Announcement}[9]{
	...
	% SETTING IMAGE RATIO
        ...
        \node at ($(canvas.south)!.5!(title.south)$) [#7, align=#8] {#2};
